...
public:
	void Schedule() override {
		...
		auto total_blocks = NumericCast<idx_t>((double(total_size) + DEFAULT_BLOCK_SIZE - 1) / DEFAULT_BLOCK_SIZE);
		...
		auto thread_memory = 2 * blocks_per_vector * partition_multiplier * DEFAULT_BLOCK_SIZE;
